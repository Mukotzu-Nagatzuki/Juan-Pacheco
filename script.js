...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadActivities() {
        ...
        actividades.forEach((activity, index) => {
            ...
            const hasFile = activity.archivo && activity.archivo !== 'sin-archivo.pdf';
                ...
                <div class="activity-file">
                    ${hasFile ? `
                        ...
                        <div class="file-actions">
                            <a class="btn-ver" href="${activity.archivo}" target="_blank">
                                <i class="fas fa-eye"></i> Ver
                            </a>
                            <a class="btn-descargar" href="${activity.archivo}" download="${activity.title}.pdf">
